...
AREA_CENTERS = {
    "芝公园": (35.658581, 139.745433),
    "押上": (35.710063, 139.8107),
    "丰洲": (35.645736, 139.796134),
    "川崎": (35.530832, 139.703598),
    "千叶市": (35.607404, 140.106515),
    "涩谷": (35.6595, 139.7005),
    "丸之内": (35.6812, 139.7639),
    "横滨": (35.4437, 139.638),
    "麻布台": (35.6602, 139.7404),
    "东京站": (35.681236, 139.767125),
    "代官山": (35.6481, 139.7037),
    "谷根千": (35.7241, 139.7656),
    "埼玉市": (35.8617, 139.6455),
    "新桥": (35.6662, 139.7586),
    "有乐町": (35.6751, 139.7633),
    "新宿": (35.6938, 139.7034),
    "原宿": (35.6702, 139.7027),
    "浦安": (35.6539, 139.9022),
    "秋叶原": (35.6984, 139.773),
    "世田谷": (35.6466, 139.6532),
    "羽田": (35.5494, 139.7798),
    "藏前": (35.7044, 139.7905),
    "上野": (35.7148, 139.7745),
    "六本木": (35.6628, 139.7314),
    "御茶水": (35.6994, 139.7649),
    "大田": (35.5613, 139.716),
    "芝浦/台场": (35.638, 139.763),
    "汐留": (35.6642, 139.7597),
    "船桥": (35.7016, 139.985),
    "市川": (35.7219, 139.931),
    "越谷": (35.8911, 139.7909),
    "荒川/北区": (35.7504, 139.7374),
    "吉祥寺": (35.7031, 139.5798),
    "九段下": (35.6956, 139.7518),
    "青山": (35.6653, 139.7124),
    "小田原": (35.255, 139.1597),
    "横须贺": (35.2813, 139.6722),
    "王子": (35.7528, 139.7382),
    "藤泽/镰仓": (35.3192, 139.5256),
    "川越": (35.9251, 139.4858),
    "成田": (35.7767, 140.3189),
    "镰仓": (35.3195, 139.5505),
    "富津/鋸南": (35.1969, 139.834),
    "鋸南": (35.1113, 139.8356),
    "行田": (36.1389, 139.4557),
    "小川町": (36.0588, 139.2617),
    "木更津": (35.3814, 139.924),
    "秩父": (35.9917, 139.0855),
    "市原": (35.4981, 140.1154),
    "叶山": (35.272, 139.5867),
    "奥多摩": (35.8095, 139.0962),
    "青梅": (35.788, 139.2758),
    "袖ケ浦": (35.4297, 139.9543),
    "香取": (35.8977, 140.4992),
    "滑川": (36.0658, 139.3602),
    "御宿": (35.1883, 140.3488),
    "热海": (35.0952, 139.0717),
    "大洗": (36.3134, 140.5747),
    "富士五湖": (35.5036, 138.769),
    "真鹤": (35.156, 139.137),
    "箱根": (35.2324, 139.1069),
    "馆山": (34.9965, 139.8699),
    "胜浦": (35.1523, 140.3209),
    "三岛": (35.1185, 138.9186),
    "大多喜": (35.2852, 140.2454),
    "饭能": (35.8557, 139.3188),
    "大月": (35.6106, 138.9401),
    "富冈": (36.2596, 138.8899),
    "君津": (35.3307, 139.9026),
    "东秩父": (36.0589, 139.1949),
    "銚子": (35.734, 140.8267),
    "土浦": (36.0785, 140.2046),
    "相模湾": (35.233, 139.28),
    "山中湖": (35.4107, 138.8608),
    "安中": (36.3264, 138.8878),
    "旭": (35.7167, 140.6467),
    "常陆那珂": (36.3966, 140.5347),
    "筑波": (36.225, 140.1068),
    "皆野/东秩父": (36.067, 139.124),
}
...
def approximate_location(spot: dict) -> dict:
    area = str(spot.get("区域", ""))
    if area in AREA_CENTERS:
        center = AREA_CENTERS[area]
        source = "area-approx"
    else:
        area_parts = [part for part in re.split(r"[/・]", area) if part]
        center = next((AREA_CENTERS[part] for part in area_parts if part in AREA_CENTERS), None)
        source = "area-approx"
        if center is None:
    ...
    radius = 0.01 + (digest[2] / 255) * (0.035 if source == "area-approx" else 0.18)
